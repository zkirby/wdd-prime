...
class Farmer {
	...
	// Returns a list of all farmers if there 
	// are any farmers, or a new farmers map if none exists.
	static get_farmers() {
		let fp = localStorage.getItem("all_farmers");
		if (fp) {
